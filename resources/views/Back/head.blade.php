...
<head>
    ...
    <title>E-Santé - Medical & Hospital - Admin Dashboard</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('Back/assets/css/bootstrap-datetimepicker.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('Back/assets/css/select2.min.css')}}">
